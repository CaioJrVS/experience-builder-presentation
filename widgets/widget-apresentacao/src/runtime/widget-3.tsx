...
const Widget = (props: AllWidgetProps<any>) => {
  // Cria State para salvar a view do mapa selecionado
  const [jmv, setJmv] = React.useState<JimuMapView>(null)
  const [objectId, setObjectId] = React.useState<string>('')

  // Metodo chamado quando a view o componente JimuMapViewComponent é alterado
  ...
  return (
    <div>
      {/* Adiciona JimuMapViewComponent para pegar a view do mapa selecionado no setting.tsx*/}
      {
